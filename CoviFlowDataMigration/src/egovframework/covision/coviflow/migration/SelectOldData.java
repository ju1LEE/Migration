	...
	public JSONArray selectOldFormInstanceData(int startID, int endID) throws Exception{
		...
		try {
	        ...
	        while ( rs.next() ) {
	        	...
	        	formInstData.put("DocLinks", rs.getString("DOCLINKS")!=null?rs.getString("DOCLINKS").replace("'", "\\'") : "");
	...
	public JSONArray selectOldProcessData(String oldFormInstID) throws Exception{
		...
		try {
	        ...
	        while ( rs.next() ) {
	        	...
	        	processData.put("DocSubject", rs.getString("PROCESS_SUBJECT").replace("\\", "\\\\").replace("'", "\\'"));
	        	processData.put("BusinessState", rs.getString("BUSINESS_STATE")!=null ? rs.getString("BUSINESS_STATE") : "02_01_01");
	        	...
	        	processData.put("FormPrefix", "WF_MIGRATION");
	        	...
	        	processData.put("Reserved1", rs.getString("PROCESS_ID"));
	        	processData.put("Reserved2", rs.getString("PARENT_PROCESS_ID"));
	        	processData.put("BusinessData1", rs.getString("PDEF_ID"));
